@extends('layouts.vertical', ['title' => 'Error 500'])
            ...
            <div class="col-xxl-3 col-lg-5 col-md-6">
                ...
                <div class="card overflow-hidden text-center p-xxl-4 p-3 mb-0">
                    <div class="text-center">
                        ...
                        <p class="text-muted mb-3">Why not try refreshing your page? or you can contact <a class="text-dark"
                                href=""><b>Support</b></a></p>
                        <a class="btn btn-danger" href="/"><i class="ti ti-home fs-16 me-1"></i> Back to Home</a>
                    </div>
                </div>

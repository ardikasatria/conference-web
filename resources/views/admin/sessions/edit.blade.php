...
<div class="container-fluid">
    @include('layouts.partials.page-title', ['title' => 'Edit Session', 'subtitle' => $session->title])
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.sessions.update', $session) }}">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $session->description) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" name="start_time" class="form-control @error('start_time') is-invalid @enderror" value="{{ old('start_time', $session->start_time?->format('Y-m-d\TH:i')) }}" required>
                                @error('start_time')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">End Time <span class="text-danger">*</span></label>
                                <input type="datetime-local" name="end_time" class="form-control @error('end_time') is-invalid @enderror" value="{{ old('end_time', $session->end_time?->format('Y-m-d\TH:i')) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="room" class="form-control @error('room') is-invalid @enderror" value="{{ old('room', $session->room) }}">
                                @error('room')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Capacity</label>
                                <input type="number" name="capacity" class="form-control @error('capacity') is-invalid @enderror" value="{{ old('capacity', $session->capacity) }}" min="0">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            @php $selectedSpeakers = old('speakers', $session->speakers->pluck('id')->toArray()); @endphp
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i> Update Session</button>

...
<div class="container-fluid">
    @include('layouts.partials.page-title', ['title' => 'Create User', 'subtitle' => 'Add a new user'])
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="role" class="form-select @error('role') is-invalid @enderror">
                                ...
                                @foreach($roles as $role)
                                    <option value="{{ $role->id }}" {{ old('role') == $role->id ? 'selected' : '' }}>{{ $role->display_name ?? $role->name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i> Create User</button>

                ...
                <div class="card overflow-hidden text-center p-xxl-4 p-3 mb-0">
                    ...
                    <form action="/" class="text-start mb-3">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <a class="text-muted border-bottom border-dashed" href="{{ route('second', ['auth', 'recoverpw'])}}">Forget
                                Password</a>
                        </div>
                        <div class="d-grid">
                    ...
                    <p class="text-muted fs-14 mb-0">Don't have an account?
                        <a class="fw-semibold text-danger ms-1" href="{{ route('second', ['auth', 'register'])}}">Sign Up !</a>
                    </p>
                </div>
